...
class Node:
    ...
    def update_indicator(self):
        """Create the indicator function from the node bounds."""
        def is_large_enough(x):
            """Check whether all features exceed their lower bounds."""
            comparisons = [
        ...
        def is_small_enough(x):
            """Check whether all features satisfy their upper bounds."""
            comparisons = [
        ...
        def indicator(x):
            """Return individuals that satisfy all node conditions."""
            conditions = np.array([
                is_large_enough(x),
                is_small_enough(x)
            ])
